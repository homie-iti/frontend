...
- _src_: root of the source code

  - _app_: angular application

    - _models_: models used in the application
      ...
      - user module : contain any thing belong user
        - user components:
          ...
          - user profile page
            ...
            - user unit listing
          - user wishlist
    - _services_: services handling data flow
      - admin service
      - auth service
      - getdata service
      - transfer-data service

  - _assets_: static assets ==>contain some static images
  - _environments_: definition of production or test environment
  - _styles_: CSS styles
